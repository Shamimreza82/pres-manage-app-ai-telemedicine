...
import { Plus, Search, MoreHorizontal, Eye, Trash2, Users, Pencil, FileText } from 'lucide-react';
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <Link href={`/prescriptions/new?patientId=${patient.id}`} onClick={() => setMenuTarget(null)}>
                    <button className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <FileText className="h-4 w-4 text-teal-500" /> Create Prescription
                    </button>
                  </Link>
